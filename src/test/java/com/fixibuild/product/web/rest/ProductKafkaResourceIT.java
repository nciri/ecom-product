package com.fixibuild.product.web.rest;

import static org.assertj.core.api.Assertions.assertThat;

import com.fixibuild.product.IntegrationTest;
import com.fixibuild.product.config.EmbeddedKafka;
import com.fixibuild.product.config.KafkaSseConsumer;
import com.fixibuild.product.config.KafkaSseProducer;
...
class ProductKafkaResourceIT {
    ...
    void producesMessages() throws InterruptedException {
        client.post().uri("/api/product-kafka/publish?message=value-produce").exchange().expectStatus().isNoContent();
